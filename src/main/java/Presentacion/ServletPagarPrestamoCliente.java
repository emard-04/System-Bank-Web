...
public class ServletPagarPrestamoCliente extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			if (paramCuota == null || paramCuota.trim().isEmpty() || paramCuenta == null
					|| paramCuenta.trim().isEmpty()) {
			...
			request.getSession().setAttribute("mensaje",
					"❌ Error: datos inválidos. Asegúrese de seleccionar una cuenta y una cuota.");
			response.sendRedirect(request.getContextPath() + "/ServletPagarPrestamoCliente");
		} catch (Exception e) {
			e.printStackTrace();
	...
	public void agregarMovimiento(HttpServletRequest request, int idCuota, int nroCuenta)
			throws ServletException, IOException {
