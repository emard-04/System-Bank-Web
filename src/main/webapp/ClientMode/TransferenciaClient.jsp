            ...
            <div class="p-6 flex-1 flex flex-col items-center justify-center">
                <div class="bg-white p-8 rounded-lg shadow-md w-full max-w-md">
                    <form action="TransferirServlet" method="post" class="space-y-6">
                        <div class="mb-4">
                            <label for="monto" class="block text-gray-700 text-lg font-semibold mb-2">Monto a transferir</label>
                            <input
                                type="number"
                                id="monto"
                                name="monto"
                        ...
                        <div class="mb-4">
                            <label for="alias_cbu" class="block text-gray-700 text-lg font-semibold mb-2">Alias / CBU</label>
                            <input
                                type="text"
                                id="alias_cbu"
                                name="alias_cbu"
                        ...
                        <div class="mb-6">
                            <label for="referencia" class="block text-gray-700 text-lg font-semibold mb-2">Referencia</label>
                            <input
                                type="text"
                                id="referencia"
                                name="referencia"
