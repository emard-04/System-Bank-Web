        ...
        <main class="flex-1 flex flex-col overflow-y-auto">
            ...
            <nav class="bg-gray-50 border-b border-gray-200 p-4">
                <ul class="flex space-x-4">
                    ...
                    <li><a href="clientesAdmin_borrar.jsp" class="bg-blue-600 text-white font-semibold py-2 px-4 rounded-md focus:outline-none focus:shadow-outline transition duration-200 ease-in-out">Borrar</a></li>
                </ul>
            </nav>
            ...
            <div class="p-6 flex-1 flex flex-col justify-center items-center">
                <div class="bg-white p-8 rounded-lg shadow-md w-full max-w-md">
                    <form action="BorrarClienteServlet" method="post" class="space-y-6 text-center">
                        <p class="text-gray-700 text-lg font-semibold mb-4">Seleccione un DNI que quieras eliminar:</p>
