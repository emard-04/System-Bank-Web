        ...
        <main class="flex-1 flex flex-col overflow-y-auto">
            ...
            <nav class="bg-gray-50 border-b border-gray-200 p-4">
                <ul class="flex space-x-10 justify-center">
                    <li><a href="clientesAdmin.jsp" class="hover:bg-blue-600 hover:text-white text-gray-700 font-semibold py-2 px-4 rounded-md focus:outline-none focus:shadow-outline transition duration-200 ease-in-out">Listado</a></li>
                    ...
                    <li><a href="clientesAdmin_modificar.jsp" class="bg-blue-600 text-white font-semibold py-2 px-4 rounded-md focus:outline-none focus:shadow-outline transition duration-200 ease-in-out">Modificar</a></li>
            ...
            <div class="p-6 flex-1 flex flex-col items-center">
                <div class="bg-white p-8 rounded-lg shadow-md w-full max-w-4xl">
                    <div class="mb-8 pb-4 border-b border-gray-200 flex items-center justify-center">
                        <label for="seleccionar_cliente_dni" class="block text-gray-700 text-lg font-semibold mr-4">Seleccionar DNI del Cliente:</label>
                        <select
                            id="seleccionar_cliente_dni"
                    ...
                    <form action="ModificarClienteServlet" method="post" class="grid grid-cols-1 md:grid-cols-3 gap-x-8 gap-y-6">
                        <input type="hidden" id="dni_original_modificar" name="dni_original_modificar" value="">

                        <div>
                            <label for="dni_mod" class="block text-gray-700 text-lg font-semibold mb-2">DNI</label>
                            <input
                                type="text"
                                id="dni_mod"
                                name="dni_mod"
                        ...
                        <div>
                            <label for="nombre_mod" class="block text-gray-700 text-lg font-semibold mb-2">Nombre</label>
                            <input
                                type="text"
                                id="nombre_mod"
                                name="nombre_mod"
                        ...
                        <div>
                            <label for="apellido_mod" class="block text-gray-700 text-lg font-semibold mb-2">Apellido</label>
                            <input
                                type="text"
                                id="apellido_mod"
                                name="apellido_mod"
                        ...
                        <div>
                            <label for="direccion_mod" class="block text-gray-700 text-lg font-semibold mb-2">Direccion</label>
                            <input
                                type="text"
                                id="direccion_mod"
                                name="direccion_mod"
                        ...
                        <div>
                            <label for="nacionalidad_mod" class="block text-gray-700 text-lg font-semibold mb-2">Nacionalidad</label>
                            <input
                                type="text"
                                id="nacionalidad_mod"
                                name="nacionalidad_mod"
                                placeholder=""
                                class="p-3 border border-gray-300 rounded-md w-full focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-lg"
                                required
                            >
                        ...
                        <div>
                            <label for="fecha_nacimiento_mod" class="block text-gray-700 text-lg font-semibold mb-2">Fec Nacimiento</label>
                            <input
                                type="date"
                        ...
                        <div>
                            <label for="correo_electronico_mod" class="block text-gray-700 text-lg font-semibold mb-2">Correo Electronico</label>
                            <input
                                type="email"
                                id="correo_electronico_mod"
                        ...
                        <div>
                            <label for="sexo_mod" class="block text-gray-700 text-lg font-semibold mb-2">Sexo</label>
                            <select
                                id="sexo_mod"
                                name="sexo_mod"
                                class="p-3 border border-gray-300 rounded-md w-full focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-lg bg-white"
                        ...
                        <div>
                            <label for="usuario_mod" class="block text-gray-700 text-lg font-semibold mb-2">Usuario</label>
                            <input
                                type="text"
                                id="usuario_mod"
                                name="usuario_mod"
                        ...
                        <div>
                            <label for="contrasena_mod" class="block text-gray-700 text-lg font-semibold mb-2">Contraseña</label>
                            <input
                                type="password"
                                id="contrasena_mod"
                                name="contrasena_mod"
